    ...
    "js/prism.js"(exports, module) {
      ...
      var Prism = function(e) {
            ...
            if (a.hooks.run("before-highlight", s2), s2.grammar)
              if (t2 && e.Worker) {
                ...
                c2.onmessage = function(e2) {
                  ...
                  JSON.stringify({ language: s2.language, code: s2.code, immediateClose: true })
                );
              } else
        ...
        if (e.Prism = a, i.stringify = function e2(n2, t2) {
          ...
          return e.addEventListener ? (a.disableWorkerMessageHandler || e.addEventListener(
            "message",
            function(n2) {
